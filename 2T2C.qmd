...
ROINames <- c("Airpore Old 1", "Airpore Old 2", "Airpore Old 3", "Airpore Medium 1","Airpore Medium 2", "Airpore young 1", "background")
...
BatchData <- BatchDataset(SampleNames, DisplayNames)
```
